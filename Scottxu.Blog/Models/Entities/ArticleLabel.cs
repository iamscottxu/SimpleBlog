...
namespace Scottxu.Blog.Models.Entities
{
    ...
    public class ArticleLabel : GuidEntity
    {
        ...
        public static List<ArticleLabel> GetData(BlogSystemContext dataBaseContext, PageInfoViewModel pageInfo,
        ...
        public static void Delete(BlogSystemContext dataBaseContext, Guid[] deleteGuid) =>
            dataBaseContext.ArticleLabels.RemoveRange(
                dataBaseContext.ArticleLabels.Join(deleteGuid, l => l.Guid, r => r, (l, r) => l));
        ...
        public static void EditItem(BlogSystemContext dataBaseContext, Guid guid, string name)
        {
            ...
            if (articleLabel != null) articleLabel.Name = name;
        }

        public static IEnumerable<ArticleLabel> GetAllDataByArticle(BlogSystemContext dataBaseContext, Article article) =>
            dataBaseContext.ArticleLabelArticles.Include(o => o.ArticleLabel).Where(o => o.Article == article)
                .Select(o => o.ArticleLabel).ToList();
    }
}