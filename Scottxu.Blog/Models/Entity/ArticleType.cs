...
namespace Scottxu.Blog.Models.Entitys
{
    ...
    public class ArticleType : GuidEntity
    {
            ...
            string searchMessage, out List<ArticleType> articleTypes)
        {
            ...
            if (pageInfo == null) return searchArticleTypes;
        ...
        public static void Delete(BlogSystemContext dataBaseContext, Guid[] deleteGuid) =>
            dataBaseContext.ArticleTypes.RemoveRange(
                dataBaseContext.ArticleTypes.Join(deleteGuid, l => l.Guid, r => r, (l, r) => l));
        ...
        public static void EditItem(BlogSystemContext dataBaseContext, Guid guid, string name,
            Guid? parentArticleTypeGuid, UInt32 sequence)
        {
            FormatVerificationHelper.FormatVerification(name, FormatVerificationHelper.FormatType.ArticleTypeName,
                new ParametersFormatErrorException("类别格式错误。"));
